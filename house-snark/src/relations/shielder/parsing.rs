...
pub fn parse_frontend_merkle_path_single(
    ...
    Ok(FrontendMerklePathNode(
        FrontendNote::from_bytes(frontend_merkle_path_single.as_bytes()).0,
    ))
}
