...
```shell
# Most likely, the first thing you need to do is to generate some snarkish data using `house-snark`.
 
# Let's assume that we are in the root directory of this repo.
# Generate data:
